        ...
        <div>
            <div className="container">
                <div className=" text-center mt-5 ">
                    ...
                    <img className="logocontact" src="../../Realestatelogo.png" alt="LuxeLiving Logo" />
                                        ...
                                        <div className="controls">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-group">
                                                            ...
                                                            <input id="form_lastname" type="text" name="surname" className="form-control" placeholder=" last name *" required="required" data-error="Lastname is required."></input>
                                                        </div></div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        <label for="form_need"> your need *</label>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-12">
                                                    ...
                                                    <input type="submit" className="btn btn-success btn-send  pt-2 btn-block   " style={{FontSize:'small'}} value="Send Message"  ></input>
